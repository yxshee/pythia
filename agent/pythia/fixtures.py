...
_MOCK_MARKETS: list[dict] = [
    ...
    },
    {
        ...
        "description": "Resolves YES if the FOMC announces a 25bp rate cut at the June 16-17, 2026 meeting.",
        "yes_price": 0.42,
        "no_price": 0.58,
        "volume_24h_usd": 218_900.0,
        "liquidity_usd": 92_000.0,
        "end_date_iso": "2026-06-17T20:00:00Z",
        "tags": ["macro", "fed"],
    ...
    },
    {
        ...
        "description": "Resolves YES if BTC closes above its pre-2026 all-time high on any day during calendar year 2026.",
        "yes_price": 0.16,
        "no_price": 0.84,
    ...
    },
    {
        ...
        "description": "Resolves YES if the FOMC announces a 25bp rate cut at the July 28-29, 2026 meeting.",
        "yes_price": 0.31,
        "no_price": 0.69,
        "volume_24h_usd": 156_300.0,
        "liquidity_usd": 78_500.0,
        "end_date_iso": "2026-07-29T20:00:00Z",
        "tags": ["macro", "fed"],
    ...
    for raw in _MOCK_MARKETS:
        raw = {
            **raw,
            ...
            "source_url": f"https://polymarket.com/event/{raw['slug']}",
        }
        out.append(
            MarketCandidate(
